...
# Visualizing distribution of time_mean_demand
ggplot(df, aes(x=time_mean_demand)) + geom_histogram(bins=30) + ggtitle("Distribution of Sum Demand")

# Time series plot of time_mean_demand
ggplot(df, aes(x=dateTime, y=time_mean_demand)) + geom_line() + ggtitle("Time Series of Sum Demand")
...
ggplot(df, aes(x=temp, y=time_mean_demand)) +
    ...
    labs(x="Temperature", y="Mean Demand", title="Relationship Between Temperature and Sum Demand")
```
```{r}
